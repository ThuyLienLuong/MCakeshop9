    ...
    public partial class fStaffView : SampleView
    {
        ...
        private void gunaDataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (gunaDataGridView1.CurrentCell.OwningColumn.Name == "dgvedit")
            {
                ...
                fAdd.txtPhone.Text = Convert.ToString(gunaDataGridView1.CurrentRow.Cells["dgvPhone"].Value);
                fAdd.cbRole.Text = Convert.ToString(gunaDataGridView1.CurrentRow.Cells["dgvRole"].Value);
                fAdd.ShowDialog();
                GetData();
            }
